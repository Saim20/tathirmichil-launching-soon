...
import {
  processContent,
  extractTextContent,
} from "@/lib/utils/contentProcessor";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-tathir-cream">
        <div className="text-center">
          ...
          <p
            className={`text-tathir-brown font-bold text-xl ${bloxat.className} uppercase`}
          >
            Loading blog...
          </p>
        </div>
  ...
  return (
    <div className="min-h-screen bg-tathir-cream p-4 md:p-6 pb-16">
      <div className="max-w-4xl mx-auto space-y-6 md:space-y-8">
        ...
        {/* Blog Header */}
        <div
          className="bg-tathir-beige rounded-xl p-4 md:p-8 
        ...
        >
          <div
            ...
            className="prose prose-sm md:prose-2xl max-w-none text-tathir-brown leading-relaxed blog-content jersey-10-regular
                ...
                [&_h1]:text-tathir-maroon [&_h1]:font-bold [&_h1]:text-xl [&_h1]:md:text-4xl [&_h1]:mt-4 [&_h1]:md:mt-6 [&_h1]:mb-3 [&_h1]:md:mb-4 [&_h1]:break-words
                [&_h2]:text-tathir-maroon [&_h2]:font-bold [&_h2]:text-lg [&_h2]:md:text-3xl [&_h2]:mt-3 [&_h2]:md:mt-5 [&_h2]:mb-2 [&_h2]:md:mb-3 [&_h2]:break-words
                [&_h3]:text-tathir-maroon [&_h3]:font-bold [&_h3]:text-base [&_h3]:md:text-2xl [&_h3]:mt-3 [&_h3]:md:mt-4 [&_h3]:mb-2 [&_h3]:break-words
                ...
                [&_pre]:overflow-x-auto [&_pre]:text-sm [&_pre]:md:text-lg [&_pre]:bg-tathir-cream [&_pre]:p-3 [&_pre]:rounded-lg [&_pre]:my-4
                [&_code]:text-sm [&_code]:md:text-lg [&_code]:bg-tathir-cream [&_code]:px-1 [&_code]:py-0.5 [&_code]:rounded [&_code]:break-all"
            style={{
              fontSize: "20px",
              lineHeight: "1.7",
            }}
