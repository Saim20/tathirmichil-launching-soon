          ...
          <div className="text-center space-y-8">
            ...
            <div className="space-y-8">
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                {selectedBatch === "crash" ? (
                  <div
                    className={`px-10 py-5 bg-gray-400 text-gray-600 font-bold rounded-xl cursor-not-allowed
                      [box-shadow:2px_2px_0_#888,4px_4px_0_#888,6px_6px_1px_rgba(0,0,0,.1)]
                      inline-flex items-center justify-center gap-2 relative overflow-hidden opacity-60 ${bloxat.className}`}
                  >
